...
mkdir -p ~/.themes/
timeout 300 curl --progress -k -L -f "https://dl.opendesktop.org/api/files/downloadfile/id/1461767736/s/b7f21a828d36de84c1680119f36f6a73/t/1517093056/u//90145-axiom.tar.gz" > /tmp/axiom.tar.gz \
...
##### Remove Gnome session to make xfce default
(( STAGE++ )); echo -e "\n\n ${GREEN}[+]${RESET} (${STAGE}/${TOTAL}) Removing gnome-session"
apt remove -y --purge gnome-session
